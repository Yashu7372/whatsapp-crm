...
export type DocumentRecord = { id:string; title:string; docType:string; status:string; projectId?:string; documentCode?:string; dueAt?:string; approvedValue?:number; reviewOutcome?:string; currentVersion:number; updatedAt:string };
